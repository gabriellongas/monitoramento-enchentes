...
create procedure [dbo].[spConsultaAvancadaRegiao]
(
	@Nome varchar(max),
	@Cidade varchar(max),
	@Estado varchar(max))
...
begin
	...
	select * from Regiao r where r.Nome like '%' + @nome + '%' and
								 r.Cidade like '%' + @Cidade + '%' and
								 r.Estado like '%' + @Estado + '%'
end

exec spConsultaAvancadaRegiao 'a', '', ''
